...
from .core import children,set_trainable_attr,apply_leaf,USE_GPU,set_trainable,save_model,T,load_ner_model,to_gpu
from .data_utils import pad_sequences, minibatches, get_chunks
from .crf import CRF,nn,Variable
import torch
...
class NERLearner(object):
    ...
    def predict_pdf(self, sentences):
        ...
        med7 = en_core_med7_trf.load()
        doc = med7(sentences)
        final_dict = [[ent.text, ent.label_] for ent in doc.ents]
        return final_dict
